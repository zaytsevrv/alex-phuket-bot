...
def generate_deepseek_response(user_query, tour_data=None, context_info=None):
    ...
    try:
        ...
        СТИЛЬ ОБЩЕНИЯ:
        - Естественный разговор: "Отличный выбор!", "Расскажу подробнее..."
        ...
        if tour_data:
            ...
            Название: {tour_data.get('Название', 'Не указано')}
            Цена взрослый: {tour_data.get('Цена Взр', 'Не указана')} THB
            Цена детский: {tour_data.get('Цена Дет', 'Не указана')} THB
            Описание: {tour_data.get('Описание (Витрина)', 'Не указано')}
            Честный обзор: {tour_data.get('Честный обзор', 'Не указано')}
            Важная информация: {tour_data.get('Важная информация', 'Не указано')}
            Ссылка: {tour_data.get('Ссылка', 'Не указана')}
            Теги безопасности: {tour_data.get('Теги (Безопасность)', 'Не указаны')}
            """
